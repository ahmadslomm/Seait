...
import { UserModule, RoomModule, WalletModule, MallModule, TaskModule, NoticeModule,
         ActivityModule, SearchModule, MedalModule, AgencyModule, ThemeModule, GiftModule, RoomApiModule, RoomAdminModule, GameModule, PkModule, FeedModule, RoomEventsModule, AccountModule } from '../modules';
...
export class ActionRouter {
  ...
  constructor(
    ...
    search: SearchModule, medal: MedalModule, agency: AgencyModule, theme: ThemeModule, gift: GiftModule, roomApi: RoomApiModule, roomAdmin: RoomAdminModule,
    game: GameModule, pk: PkModule, feed: FeedModule,
    roomEvents: RoomEventsModule, account: AccountModule,
  ) {
    ...
    const mods: ApiModule[] = [user, room, wallet, mall, task, notice, activity, search, medal, agency, theme, gift, roomApi, roomAdmin, game, pk, feed, roomEvents, account];
    for (const m of mods) {
