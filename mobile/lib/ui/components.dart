...
class CoinIcon extends StatelessWidget { final double s; const CoinIcon({super.key,this.s=34});
  @override Widget build(BuildContext c)=>Image.asset('../assets/ui/coin_icon.png', width:s, height:s, errorBuilder:(_,__,___)=>Icon(Icons.monetization_on,color:ZC.coin,size:s)); }
class DiamondIcon extends StatelessWidget { final double s; const DiamondIcon({super.key,this.s=34});
  @override Widget build(BuildContext c)=>Image.asset('../assets/ui/diamond_icon.png', width:s, height:s, errorBuilder:(_,__,___)=>Icon(Icons.diamond,color:ZC.diamond,size:s)); }
class VipMedallion extends StatelessWidget { final double s; const VipMedallion({super.key,this.s=150});
  @override Widget build(BuildContext c)=>Image.asset('../assets/ui/vip_medallion.png', width:s, errorBuilder:(_,__,___)=>Icon(Icons.workspace_premium,color:ZC.gold,size:s)); }
